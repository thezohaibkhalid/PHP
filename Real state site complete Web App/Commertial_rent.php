...
<?php include 'assets/components/nav.php'?>
    ...
    <div class="container-fluid d-flex justify-content-between p-4 mb-4">
        <h1 class="title">Properties for Rent in Islamabad</h1>
    ...
    <div class="container-fluid justify-content-around row mb-5">
        ...
        $query = "SELECT * from `properties` WHERE `city` ='islamabad' AND `category`= 'commertial_rent' LIMIT 3 ";
    ...
    <div class="container-fluid justify-content-around mb-5 row">
        ...
        $query = "SELECT * from `properties` WHERE `city` ='karachi' LIMIT 3 ";
        $result = mysqli_query($conn, $query);
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="card col-4 p-0 border-0 pfr mb-5">
    <img src="' . substr($row['imgAddress'] , 6 ) . '" alt="">
    ...
    <div class="container-fluid justify-content-around mb-5 row">
        ...
        $query = "SELECT * from `properties` WHERE `city` ='Faisalabad' LIMIT 3 ";
        $result = mysqli_query($conn, $query);
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="card col-4 p-0 border-0 pfr mb-5">
<img src="' . substr($row['imgAddress'] , 6 ) . '" alt="">
...
<div>' . $row['location'] . '</div>
    ...
    <div class="container-fluid justify-content-around mb-5 row">
        ...
        $query = "SELECT * from `properties` WHERE `city` ='Lahore' LIMIT 6 ";
        $result = mysqli_query($conn, $query);
        while ($row = mysqli_fetch_assoc($result)) {
            echo '<div class="card col-4 p-0 border-0 pfr mb-5">
            <img src="' . substr($row['imgAddress'] , 6 ) . '" alt="">

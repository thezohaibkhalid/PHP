<?php 
    ...
    function data($city , $limit) {
        ...
        $query = "SELECT * from `properties` WHERE `city` ='$city' AND `category` = 'residential_sale' LIMIT $limit ";
...
<?php include 'assets/components/nav.php'?>
    ...
    <div class="container-fluid d-flex justify-content-between p-4 mb-4">
        <h1 class="title">Properties for Sale in Islamabad</h1>
    ...
    <div class="container-fluid d-flex justify-content-between p-4 mb-4">
        <h1 class="title">Properties for Sale in Karachi</h1>
        <div class="btn rounded-3 fw-semibold text-white my-3 me-4" style="background-color: #FF573B;">View All</div>
    </div>
    ...
    <!-- Properties for sale in Faisalabad -->
    <div class="container-fluid d-flex justify-content-between p-4 mb-4">
        <h1 class="title">Properties for Sale in Faisalabad</h1>
        <div class="btn rounded-3 fw-semibold text-white my-3 me-4" style="background-color: #FF573B;">View All</div>
    </div>
    <div class="container-fluid justify-content-around mb-5 row">
    ...
    <div class="container-fluid d-flex justify-content-between p-4 mb-4">
        <h1 class="title">Properties for Sale in Lahore</h1>
        <div class="btn rounded-3 fw-semibold text-white my-3 me-4" style="background-color: #FF573B;">View All</div>
    </div>
    <div class="container-fluid justify-content-around mb-5 row">
    <?php data('Lahore',6)?>
